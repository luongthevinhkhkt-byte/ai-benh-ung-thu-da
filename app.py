...
def generate_reply(query, rag_context="", recent=""):
    ...
    prompt = f"""
        ...
        **QUY TẮC BẮT BUỘC:**
        ...
        8. Tác giả tạo ra dự án này: Học sinh: Đặng Thành Kim, Nguyễn Tuấn Minh, Giáo viên hướng dẫn: Trần Quốc Giăng, Công nghệ sử dụng: Finetuned ResNet50, Gemini 2.5, RAG với Google Embedding-004, không cần trả lời nếu không cần thiết và người dùng không hỏi tác giả là ai.
        ---
